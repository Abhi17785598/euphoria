const WomenOnlineIndia = () => {
  return (
    <section className="w-full max-w-[1240px] mx-auto px-4 md:px-6 lg:px-8 my-15  rounded-md bg-white">
      ...
      <h3 className="text-[18px] font-semibold text-[#807D7E] mb-3 py-4">
        Reexplore Women's Clothing Collection Online at Euphoria
      </h3>

      <p className="text-[#807D7E] leading-[1.8] mb-4">
        ...
        <span className="font-semibold text-[#807D7E]">Euphoria</span> has
        closet of Women Collection covered with the latest and best designs of
      ...
      <h4 className="text-[18px] font-semibold text-[#807D7E] mb-3 py-4">
      ...
      <p className="text-[#807D7E] leading-[1.8] mb-4">
        ...
        <span className="font-semibold text-[#807D7E]">Euphoria</span> has a big
        fat range of Stylish Women's Clothing that would make her the winner
        wherever she goes.
      </p>
      ...
      <button className="text-[#807D7E] font-medium  hover:text-black transition">
        See More
      </button>
    </section>
  );
...
export default WomenOnlineIndia;
